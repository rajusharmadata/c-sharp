...
namespace std
{
    class program5
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(Math.Log(10));// Return the log 
            Console.WriteLine(Math.PI);// Return the power 
            Console.WriteLine(Math.Asin(90));// Return the Asin value in Radian 
            Console.WriteLine(Math.Tan(90));// Return the power 
        }
    }
}